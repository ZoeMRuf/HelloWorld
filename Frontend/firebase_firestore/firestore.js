...
DatabaseAccess.addMap("Wagner IV Projection","Karl Heinrich (Karlheinz) Wagner","1932","../map_images/Wagner_IV.png","The Wagner IV is an equal-area pseudocylindrical projection for world maps. Its meridians follow a portion of ellipses compared to the Eckert IV projection whose meridians are semiellipses. The Wagner IV projection was introduced by Karl Heinrich (Karlheinz) Wagner in 1932. It was independently developed by Reinholds V. Putniņš in 1934, therefore it is also known as Putniņš P'2 projection.","Wagner IV is a pseudocylindric projection. The meridians, except the central meridian, are following portions of ellipses, and they bulge away from the central meridian. The meridians at 103°55' away from the central line are circular arcs. The central meridian is a straight line, half the length of the projected equator. All parallels are straight lines, perpendicular to the central meridians, and unequally spaced. Both poles are displayed as straight lines, half the length of projected equator. The graticule is symmetric across the equator and the central meridian.","Wagner IV is an equal-area (equivalent) projection. Shapes, directions, angles, and distances are distorted and stretched north-south in tropical and mid-latitude areas. Nearer the poles, features are compressed in the north-south direction. Points 42°59' north and south of the central meridian have zero distortion. Distortion values are symmetric across the equator and the central meridian.","The projection is appropriate for small-scale mapping, especially for thematic world maps illustrating area characteristics and analysis requiring accurate areas.","09")

DatabaseAccess.addMap("Winkel Tripel Projection","Oswald Winkel","1921","../map_images/Winkel_tripel.png","The Winkel Tripel is a compromise modified azimuthal projection for world maps. It is an arithmetic mean of projected coordinates of Aitoff and equidistant cylindrical projections. The projection is known to have one of the lowest mean scale and area distortions among compromise projections for small-scale mapping. It has been used by the National Geographic Society since 1998 for general world maps. The Winkel Tripel projection was introduced by Oswald Winkel in 1921. In his original design, Winkel used a standard parallel at 50°28ʹ. Inverse equations were developed at Esri.","Winkel Tripel is a modified azimuthal projection. The equator and the central meridian are projected as straight lines. The other meridians are complex curves, concave toward the central meridians and equally spaced along the equator. The parallels are equally spaced along the central meridian and concave toward the nearest pole. Both poles project as straight lines. The lengths of the central meridian and both pole lines depend on the position of the standard parallel. The graticule is symmetric across the equator and the central meridian.","The Winkel Tripel projection is neither conformal nor equal-area. It generally distorts shapes, areas, distances, directions, and angles. The scale is constant along the equator and true along the central meridian. As with most compromise projections, Winkel Tripel exaggerates polar areas. This projection has low mean scale and area distortion. Distortion values are symmetric across the equator and the central meridian.","The Winkel Tripel projection is appropriate for general world maps. A variant with a standard parallel at 50°28' has been used by the National Geographic Society since 1998.","10")